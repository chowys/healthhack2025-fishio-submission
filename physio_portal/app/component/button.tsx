...
const Button = ({ children, ...rest }: ButtonProps) => {
  return (
    <button
      {...rest}
      className="group relative px-40 py-15 font-semibold text-white text-2xl bg-[#ffff] border-4 border-[#075540] transition-all duration-200 hover:bg-white hover:text-[#228B22] hover:border-[#075540]"
    >
      <span>{children}</span>
